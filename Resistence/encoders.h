...
volatile long countRight; // used by encoder to count the rotation
...
volatile long countLeft; // used by encoder to count the rotation
...
// This ISR handles just Encoder 1  (RIGHT)
...
// This ISR handles just Encoder 0 (LEFT)
